<template>
  <div>
    <img :src="
    'https://image.tmdb.org/t/p/original/' + movie.backdropPath" alt="" class="backImg" />
    <div class="detailForm">
      <p class="detail-subtitle">당신의 힐링을 위한 영화:</p>
  ...
  methods: {
    registComment() {
      if (this.content.length > 0) {
        ...
        comment.articleId = this.movie.id;
        comment.category = "movie";
        ...
        this.$store.dispatch('readComment', { category: 'movie', articleId: this.movie.id });
        this.movie.commentCnt++;
        this.content = "";
      }
    }
  },
...
.movie-detail {
  background: url("../../assets/movie/poster.jpg") no-repeat;
